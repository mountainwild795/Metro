const HeroComponent = () => {
  return (
    <div className="container mx-auto px-6 md:px-48 py-16 text-center">
      ...
      <a href="/properties" className="text-white px-6 md:px-16 py-2 md:py-4 mt-2 rounded-lg transition duration-300 hover:opacity-60" style={{ backgroundColor: "#E3353B" }}>
